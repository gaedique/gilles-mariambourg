...
interface SpineHeroProps {
  introduction: SpineIntroduction;
}

const SpineHero = ({ introduction }: SpineHeroProps) => {
  return (
    <section
    ...
    >
      ...
      <div className="hidden" aria-hidden="true" data-seo-metadata>
        <div data-schema="MedicalSpecialty">
          <span data-prop="name">Spine Surgery</span>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg border border-brand-bay-of-many-100/40 h-full">
            ...
            <div className="absolute inset-0">
              <TexturedBackground
                ...
                baseFrom="from-emerald-100/70"
                baseVia="via-brand-bay-of-many-300/50"
                baseTo="to-teal-200/30"
                spotOneColor="bg-teal-200/50"
                spotTwoColor="bg-emerald-200/40"
                noiseOpacity={50}
                noiseContrast={140}
                flipX={true}
                flipY={true}
