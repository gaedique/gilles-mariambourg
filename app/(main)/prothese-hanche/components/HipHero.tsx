...
interface HipHeroProps {
  introduction: HipIntroduction;
}

const HipHero = ({ introduction }: HipHeroProps) => {
  return (
    <section
    ...
    >
      ...
      <div className="hidden" aria-hidden="true" data-seo-metadata>
        <div data-schema="MedicalSpecialty">
          <span data-prop="name">Hip Replacement Surgery</span>
