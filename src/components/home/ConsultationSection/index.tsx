...
//         <div
//           className={`flex flex-col items-center justify-center mb-16 sm:mb-24 transition-all duration-700 ${
...
//             </h2>
//           </div>
//           <h3 className="text-xl text-slate-600 uppercase tracking-wide mt-2 text-center">
//             Le parcours de soin
//           </h3>
//         </div>
...
import { CONSULTATION_CARDS } from "./constants/constants";
    ...
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="grid grid-cols-1 divide-y divide-gray-200">
            <div className="h-[250px]">
              <ConsultationCard {...CONSULTATION_CARDS[0]} />
            </div>
            <div className="h-[250px]">
              <ConsultationCard {...CONSULTATION_CARDS[1]} />
            </div>
          </div>
          <div className="grid grid-cols-1 divide-y divide-gray-200">
            <div className="h-[250px]">
              <ConsultationCard {...CONSULTATION_CARDS[2]} />
            </div>
            <div className="h-[250px]">
              <ConsultationCard {...CONSULTATION_CARDS[3]} />
            </div>
          </div>
        </div>
      </div>
