...
//         {/* Main content - Apply animation only to this part */}
//         <ScrollReveal threshold={0.05} duration={1250}>
//           <article className="relative pt-12 md:pt-16 px-4 sm:px-8">
//             {/* Pass required props to HeroHeading */}
//             <HeroHeading
//               id="hero-heading"
...
//         {/* Image area - DO NOT wrap this in ScrollReveal */}
//         <div className="z-10 mx-0 flex-1 w-full md:relative md:mx-auto max-w-7xl px-4 sm:px-8 pb-8">
//           <figure className="relative overflow-hidden rounded-lg md:rounded-xl lg:rounded-2xl bg-black/20 h-full">
//             {/* Image carousel */}
//             <ImageCarousel
//               specialties={specialties}
...
//             <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-black/60 to-transparent"></div>
//           </figure>
//           {/* Only animate the specialty controls */}
//           <ScrollReveal threshold={0.05} duration={1250} delay={200}>
